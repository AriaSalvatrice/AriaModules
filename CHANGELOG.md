...
- [NEW] Grabby: A lil fader for automation or manual performance of CV parameters. Right-click options to offset and invert output. Support for Poly External Scales from Quatherina's Quantizer.
- [NEW] Rotatoes: 4 tiny knobs for automation or manual performance of CV parameters. Right-click options to offset and invert output. Support for Poly External Scales from Quatherina's Quantizer.
