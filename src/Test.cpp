...
struct TestWidget : ModuleWidget {
    ...
    TestWidget(Test* module) {
        ...
        for (size_t i = 0; i < 12; i++) {
            // addInput(createInput<W::JackIn>(mm2px(Vec(10.0, 8.0 + i * 10.0)), module, Test::TEST_INPUT + i));
            // addOutput(createOutput<W::JackOut>(mm2px(Vec(20.0, 8.0 + i * 10.0)), module, Test::TEST_OUTPUT + i));
        }
