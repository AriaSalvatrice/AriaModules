...
struct SolomonWidget8 : ModuleWidget {
    ...
    SolomonWidget8(Solomon<8>* module) {
        ...
        addChild(W::createInput(mm2px(Vec(20.f, 17.f)), module, Solomon<8>::STEP_QUEUE_INPUT));
        addChild(W::createInput(mm2px(Vec( 5.f, 32.f)), module, Solomon<8>::STEP_TELEPORT_INPUT));
        addChild(W::createInput(mm2px(Vec(35.f, 32.f)), module, Solomon<8>::STEP_FORWARD_INPUT));
        addChild(W::createInput(mm2px(Vec(10.f, 47.f)), module, Solomon<8>::STEP_WALK_INPUT));
        addChild(W::createInput(mm2px(Vec(30.f, 47.f)), module, Solomon<8>::STEP_BACK_INPUT));
        ...
        addChild(W::createInput(mm2px(Vec(39.f, 81.f)), module, Solomon<8>::EXT_SCALE_INPUT));
        ...
        // Reset
        addChild(W::createInput(mm2px(Vec(3.f, 107.f)), module, Solomon<8>::RESET_INPUT));

        // Global output
        addChild(W::createOutput(mm2px(Vec(15.f, 107.f)), module, Solomon<8>::GLOBAL_TRIG_OUTPUT));
        addChild(W::createOutput(mm2px(Vec(27.f, 107.f)), module, Solomon<8>::GLOBAL_CV_OUTPUT));
        ...
        for(size_t i = 0; i < 8; i++) {
            // Inputs
            addChild(W::createInput(mm2px(Vec(xOffset +  5.f, yOffset +  0.f)), module, Solomon<8>::NODE_QUEUE_INPUT     + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 10.f)), module, Solomon<8>::NODE_SUB_1_OCT_INPUT + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 20.f)), module, Solomon<8>::NODE_SUB_3_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 30.f)), module, Solomon<8>::NODE_SUB_2_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 40.f)), module, Solomon<8>::NODE_SUB_1_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 10.f)), module, Solomon<8>::NODE_ADD_1_OCT_INPUT + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 20.f)), module, Solomon<8>::NODE_ADD_3_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 30.f)), module, Solomon<8>::NODE_ADD_2_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 40.f)), module, Solomon<8>::NODE_ADD_1_SD_INPUT  + i));
            ...
            // Outputs
            addChild(W::createOutput(mm2px(Vec(xOffset +  0.f, yOffset +  80.f)), module, Solomon<8>::NODE_GATE_OUTPUT + i));
            addChild(W::createOutput(mm2px(Vec(xOffset + 10.f, yOffset +  80.f)), module, Solomon<8>::NODE_RANDOM_OUTPUT  + i));
            addChild(W::createOutput(mm2px(Vec(xOffset +  5.f, yOffset +  88.f)), module, Solomon<8>::NODE_CV_OUTPUT + i));
            addChild(W::createOutput(mm2px(Vec(xOffset +  0.f, yOffset +  96.f)), module, Solomon<8>::NODE_LATCH_OUTPUT   + i));
            addChild(W::createOutput(mm2px(Vec(xOffset + 10.f, yOffset +  96.f)), module, Solomon<8>::NODE_DELAY_OUTPUT    + i));
...
struct SolomonWidget4 : ModuleWidget {
    ...
    SolomonWidget4(Solomon<4>* module) {
        ...
        // Global step inputs. Ordered counterclockwise.
        addChild(W::createInput(mm2px(Vec(20.f, 17.f)), module, Solomon<4>::STEP_QUEUE_INPUT));
        addChild(W::createInput(mm2px(Vec( 5.f, 32.f)), module, Solomon<4>::STEP_TELEPORT_INPUT));
        addChild(W::createInput(mm2px(Vec(35.f, 32.f)), module, Solomon<4>::STEP_FORWARD_INPUT));
        addChild(W::createInput(mm2px(Vec(10.f, 47.f)), module, Solomon<4>::STEP_WALK_INPUT));
        addChild(W::createInput(mm2px(Vec(30.f, 47.f)), module, Solomon<4>::STEP_BACK_INPUT));
        ...
        addChild(W::createInput(mm2px(Vec(39.f, 81.f)), module, Solomon<4>::EXT_SCALE_INPUT));
        ...
        // Reset
        addChild(W::createInput(mm2px(Vec(3.f, 107.f)), module, Solomon<4>::RESET_INPUT));

        // Global output
        addChild(W::createOutput(mm2px(Vec(15.f, 107.f)), module, Solomon<4>::GLOBAL_TRIG_OUTPUT));
        addChild(W::createOutput(mm2px(Vec(27.f, 107.f)), module, Solomon<4>::GLOBAL_CV_OUTPUT));
        ...
        for(size_t i = 0; i < 4; i++) {
            // Inputs
            addChild(W::createInput(mm2px(Vec(xOffset +  5.f, yOffset +  0.f)), module, Solomon<4>::NODE_QUEUE_INPUT     + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 10.f)), module, Solomon<4>::NODE_SUB_1_OCT_INPUT + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 20.f)), module, Solomon<4>::NODE_SUB_3_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 30.f)), module, Solomon<4>::NODE_SUB_2_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 40.f)), module, Solomon<4>::NODE_SUB_1_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 10.f)), module, Solomon<4>::NODE_ADD_1_OCT_INPUT + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 20.f)), module, Solomon<4>::NODE_ADD_3_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 30.f)), module, Solomon<4>::NODE_ADD_2_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 40.f)), module, Solomon<4>::NODE_ADD_1_SD_INPUT  + i));
            ...
            // Outputs
            addChild(W::createOutput(mm2px(Vec(xOffset +  0.f, yOffset +  80.f)), module, Solomon<4>::NODE_GATE_OUTPUT + i));
            addChild(W::createOutput(mm2px(Vec(xOffset + 10.f, yOffset +  80.f)), module, Solomon<4>::NODE_RANDOM_OUTPUT  + i));
            addChild(W::createOutput(mm2px(Vec(xOffset +  5.f, yOffset +  88.f)), module, Solomon<4>::NODE_CV_OUTPUT + i));
            addChild(W::createOutput(mm2px(Vec(xOffset +  0.f, yOffset +  96.f)), module, Solomon<4>::NODE_LATCH_OUTPUT   + i));
            addChild(W::createOutput(mm2px(Vec(xOffset + 10.f, yOffset +  96.f)), module, Solomon<4>::NODE_DELAY_OUTPUT    + i));
...
struct SolomonWidget16 : ModuleWidget {
    ...
    SolomonWidget16(Solomon<16>* module) {
        ...
        // Global step inputs. Ordered counterclockwise.
        addChild(W::createInput(mm2px(Vec(20.f, 17.f)), module, Solomon<16>::STEP_QUEUE_INPUT));
        addChild(W::createInput(mm2px(Vec( 5.f, 32.f)), module, Solomon<16>::STEP_TELEPORT_INPUT));
        addChild(W::createInput(mm2px(Vec(35.f, 32.f)), module, Solomon<16>::STEP_FORWARD_INPUT));
        addChild(W::createInput(mm2px(Vec(10.f, 47.f)), module, Solomon<16>::STEP_WALK_INPUT));
        addChild(W::createInput(mm2px(Vec(30.f, 47.f)), module, Solomon<16>::STEP_BACK_INPUT));
        ...
        addChild(W::createInput(mm2px(Vec(39.f, 81.f)), module, Solomon<16>::EXT_SCALE_INPUT));
        ...
        // Reset
        addChild(W::createInput(mm2px(Vec(3.f, 107.f)), module, Solomon<16>::RESET_INPUT));

        // Global output
        addChild(W::createOutput(mm2px(Vec(15.f, 107.f)), module, Solomon<16>::GLOBAL_TRIG_OUTPUT));
        addChild(W::createOutput(mm2px(Vec(27.f, 107.f)), module, Solomon<16>::GLOBAL_CV_OUTPUT));
        ...
        for(size_t i = 0; i < 16; i++) {
            // Inputs
            addChild(W::createInput(mm2px(Vec(xOffset +  5.f, yOffset +  0.f)), module, Solomon<16>::NODE_QUEUE_INPUT     + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 10.f)), module, Solomon<16>::NODE_SUB_1_OCT_INPUT + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 20.f)), module, Solomon<16>::NODE_SUB_3_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 30.f)), module, Solomon<16>::NODE_SUB_2_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset +  0.f, yOffset + 40.f)), module, Solomon<16>::NODE_SUB_1_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 10.f)), module, Solomon<16>::NODE_ADD_1_OCT_INPUT + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 20.f)), module, Solomon<16>::NODE_ADD_3_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 30.f)), module, Solomon<16>::NODE_ADD_2_SD_INPUT  + i));
            addChild(W::createInput(mm2px(Vec(xOffset + 10.f, yOffset + 40.f)), module, Solomon<16>::NODE_ADD_1_SD_INPUT  + i));
            ...
            // Outputs
            addChild(W::createOutput(mm2px(Vec(xOffset +  0.f, yOffset +  80.f)), module, Solomon<16>::NODE_GATE_OUTPUT + i));
            addChild(W::createOutput(mm2px(Vec(xOffset + 10.f, yOffset +  80.f)), module, Solomon<16>::NODE_RANDOM_OUTPUT  + i));
            addChild(W::createOutput(mm2px(Vec(xOffset +  5.f, yOffset +  88.f)), module, Solomon<16>::NODE_CV_OUTPUT + i));
            addChild(W::createOutput(mm2px(Vec(xOffset +  0.f, yOffset +  96.f)), module, Solomon<16>::NODE_LATCH_OUTPUT   + i));
            addChild(W::createOutput(mm2px(Vec(xOffset + 10.f, yOffset +  96.f)), module, Solomon<16>::NODE_DELAY_OUTPUT    + i));
