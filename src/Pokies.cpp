...
struct PokiesWidget : ModuleWidget {
    ...
    void drawPokie(Pokies<4>* module, float y, int num) {
        ...
        addOutput(createOutput<W::JackOutput>(mm2px(Vec(3.52f, y + 10.f)), module, Pokies<4>::CV_OUTPUT + num));
    }
    ...
    PokiesWidget(Pokies<4>* module) {
        ...
        // Global Input
        addInput(createInput<W::JackInput>(mm2px(Vec(3.52f, 15.9f)), module, Pokies<4>::GLOBAL_INPUT));
