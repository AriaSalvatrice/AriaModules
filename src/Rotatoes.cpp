...
struct Rotatoes4Widget : ModuleWidget {
    ...
    void drawRotato(Rotatoes<4>* module, float y, int num) {
        ...
        addOutput(createOutput<W::JackOutput>(mm2px(Vec(3.52f, y + 10.f)), module, Rotatoes<4>::CV_OUTPUT + num));
    ...
    Rotatoes4Widget(Rotatoes<4>* module) {
        ...
        // External
        addInput(createInput<W::JackInput>(mm2px(Vec(3.52f, 15.9f)), module, Rotatoes<4>::EXT_SCALE_INPUT));
...
struct GrabbyWidget : ModuleWidget {
    ...
    GrabbyWidget(Rotatoes<1>* module) {
        ...
        // External
        addInput(createInput<W::JackInput>(mm2px(Vec(3.52f, 15.9f)), module, Rotatoes<1>::EXT_SCALE_INPUT));

        // Grabby
        addParam(createParam<GrabbySlider>(mm2px(Vec(2.62f, 31.f)), module, Rotatoes<1>::ROTATO_PARAM + 0));
        addOutput(createOutput<W::JackOutput>(mm2px(Vec(3.52f, 104.f)), module, Rotatoes<1>::CV_OUTPUT + 0));
